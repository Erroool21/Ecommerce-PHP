    ...
    <div class='modal-dialog modal-dialog-centered' role='document'>
        <div class='modal-content'>
                            ...
                            <div class='container_form'>
                                <form action='./src/login.php' method='POST'
                                    ...
                                    <?php if(isset($_GET['error'])){ ?>
                                            <p class='error bg-danger text-light'><?php echo $_GET['error']; ?></p>
                                        <?php } ?>
                                    ...
                                    <center>
                                        <div class='form__input-group m-3'>
                                            ...
                                            <input class='inputField form-control' name='username' type='text'
                                                class='form__input' autofocus placeholder='Username or email'>
                                        </div>
                                        <div class='form__input-group m-3'>
                                            <input class='inputField form-control' name='password' type='password'
                                                class='form__input' autofocus placeholder='Password'>
                                        </div>
                                        <button class='form__button btn btn-primary w-100' type='submit'
                                            id='log-in'>Login</button>
                                    </center>
                                </form>
                            </div>
                    </div>
            ...
            <div class='modal-footer'>
                <p class='fst-italic'>Don't have an account? <a href='#' style='text-decoration: none;'>Sign up now</a>
                </p>
            </div>
        </div>
    </div>
